...
namespace!(
    ...
    chapter, "chapter",
    /// `cited by`: Relates a document to another document that cites the<br>first document.
    citedBy, "citedBy",
    /// `cites`: Relates a document to another document that is cited<br>by the first document as reference, comment, review, quotation or for<br>another purpose.
    cites, "cites",
    /// ``: 
    coden, "coden",
