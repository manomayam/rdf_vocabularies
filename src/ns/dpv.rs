...
//!
//! This module requires `ns-dpv` feature to be enabled.
//!
//! ## Vocabulary:
//!
//! |||
...
//! |**Title**||
//! |**Prefix**|dpv|
//! |**Namespace base IRI**|<http://www.w3.org/ns/dpv#>|
//! |**Description**||
//! |**Is defined by**|<https://dpvcg.github.io/dpv/dpv.jsonld>|
//!

use crate::namespace;

namespace!(
    base: "http://www.w3.org/ns/dpv#",
