...
//!
//! This module requires `ns-xhv` feature to be enabled.
//!
//! ## Vocabulary:
//!
//! |||
...
namespace!(
    ...
    terms: [
        ...
        /// `alternate`: alternate designates alternate       versions for a resource.
        (alternate, "alternate"),
        /// `appendix`: appendix refers to a resource serving       as an appendix in a collection.
        (appendix, "appendix"),
        ...
        (banner, "banner"),
        /// `bookmark`: bookmark refers to a bookmark - a link       to a key entry point within an extended document.
        (bookmark, "bookmark"),
        /// `button`: An input       that allows for user-triggered actions when clicked or pressed.
        (button, "button"),
        /// `chapter`: chapter refers to a resource serving       as a chapter in a collction.
        (chapter, "chapter"),
        /// `checkbox`: An       checkable input that has three possible values: true, false, or     mixed.
        (checkbox, "checkbox"),
        /// `cite`: cite refers to a resource that defines       a citation.
        (cite, "cite"),
        ...
        /// `contents`: contents refers to a resource serving       as a table of contents.
        (contents, "contents"),
        /// `copyright`: copyright refers to a copyright       statement for the resource.
        (copyright, "copyright"),
        ...
        (document, "document"),
        /// `first`: first refers the first item in a       collection (see also start and top).
        (first, "first"),
        /// `glossary`: glossary refers to a resource       providing a glossary of terms.
        (glossary, "glossary"),
        ...
        (help, "help"),
        /// `icon`: icon refers to a resource that       represents an icon.
        (icon, "icon"),
        /// `img`: A container       for a collection of elements that form an image.
        (img, "img"),
        /// `index`: index refers to a resource providing       an index.
        (index, "index"),
        /// `itsRules`: itsRules indicates that the designated       resource is an [ITS] rule set.
        (itsRules, "itsRules"),
        /// `last`: last refers to the last resource in a       collection of resources.
        (last, "last"),
        /// `license`: license refers to a resource that       defines the associated license.
        (license, "license"),
        ...
        /// `meta`: meta refers to a resource that       provides metadata.
        (meta, "meta"),
        /// `navigation`: navigation indicates a collection of       items suitable for navigating the document or related documents.
        (navigation, "navigation"),
        /// `next`: next refers to the next resource       (after the current one) in an ordered collection of resources.
        (next, "next"),
        ...
        (option, "option"),
        /// `p3pv1`: p3pv1 refers to a P3P Policy Reference       File [P3P].
        (p3pv1, "p3pv1"),
        /// `presentation`: An       element whose role is presentational and does not need to be mapped to       the accessibility API.
        (presentation, "presentation"),
        /// `prev`: prev refers to a previous resource       (before the current one) in an ordered collection of resources.
        (prev, "prev"),
        ...
        /// `role`: role indicates the purpose of the       resource. See the XHTML Role       Vocabulary for roles in this vocabulary space, and XHTMLROLE for information on extending the       collection of roles.
        (role, "role"),
        /// `role-properties`:
        ...
        (search, "search"),
        /// `section`: section refers to a resource serving       as a section in a collection.
        (section, "section"),
        ...
        (status, "status"),
        /// `stylesheet`: stylesheet refers to a resource       serving as a stylesheet for a resource.
        (stylesheet, "stylesheet"),
        /// `subsection`: subsection refers to a resource       serving as a subsection in a collection.
        ...
        (tooltip, "tooltip"),
        /// `top`: top is a synonym for start.
        (top, "top"),
        ...
        (treeitem, "treeitem"),
        /// `up`: up refers to a resource "above" in a       hierarchically structured set.
        (up, "up")    ]
);
