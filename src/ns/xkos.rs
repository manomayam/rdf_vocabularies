...
//!
//! This module requires `ns-xkos` feature to be enabled.
//!
//! ## Vocabulary:
//!
//! |||
...
namespace!(
    base: "http://rdf-vocabulary.ddialliance.org/xkos#",
    ...
    terms: [
        ...
        /// `maximum length`:
        (maxLength, "maxLength"),
        /// `next`: immediate successor in the sequence
        (next, "next"),
        /// `code pattern`:
        ...
        (precedes, "precedes"),
        /// `previous`: immediate predecessor in the sequence
        (previous, "previous"),
        /// `has sequential`:
