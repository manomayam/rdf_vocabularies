...
namespace!(
    ...
    componentProperty, "componentProperty",
    /// `component required`: Indicates whether a component property is required (true) or optional (false) in the context of a DSD. Only applicable<br>    to components correspond to an attribute. Defaults to false (optional).
