...
namespace!(
    ...
    /// `Base Dimension Magnitude`: <p class="lm-para">A <em>Dimension</em> expresses a magnitude for a base quantiy kind such as mass, length and time.</p><br><p class="lm-para">DEPRECATED - each exponent is expressed as a property. Keep until a validaiton of this has been done.</p>
    ...
    /// `Currency Unit`: Used for all units that express currency.
    ...
    /// `Quantity Kind Dimension Vector`: <p class="lm-para">A  <em>Quantity Kind Dimension Vector</em> describes the dimensionality of a quantity kind in the context of a system of units. In the SI system of units, the dimensions of a quantity kind are expressed as a product of the basic physical dimensions mass (\(M\)), length (\(L\)), time (\(T\)) current (\(I\)), amount of substance (\(N\)), luminous intensity (\(J\)) and absolute temperature (\(\	heta\)) as \(dim \, Q = L^{\alpha} \, M^{\eta} \, T^{\gamma} \, I ^{\delta} \, \	heta ^{\epsilon} \, N^{\eta} \, J ^{\<br>u}\).</p><br><br><p class="lm-para">The rational powers of the dimensional exponents, \(\alpha, \, \eta, \, \gamma, \, \delta, \, \epsilon, \, \eta, \, \<br>u\), are positive, negative, or zero.</p><br><br><p class="lm-para">For example, the dimension of the physical quantity kind \(\it{speed}\) is \(\oxed{length/time}\), \(L/T\) or \(LT^{-1}\), and the dimension of the physical quantity kind force is \(\oxed{mass \	imes acceleration}\) or \(\oxed{mass \	imes (length/time)/time}\), \(ML/T^2\) or \(MLT^{-2}\) respectively.</p>
