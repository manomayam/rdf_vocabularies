...
//!
//! This module requires `ns-sdmx` feature to be enabled.
//!
//! ## Vocabulary:
//!
//! |||
...
//! |**Prefix**|sdmx|
//! |**Namespace base IRI**|<http://purl.org/linked-data/sdmx#>|
...
//! |**Is defined by**|<http://purl.org/linked-data/sdmx#>|
//!

use crate::namespace;

namespace!(
    base: "http://purl.org/linked-data/sdmx#",
